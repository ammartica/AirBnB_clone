    ...
    def find_error(args, expected=0):
        ...
        if len(args) < expected:
            if len(args) == 0:
                ...
                if HBNBCommand.class_exists(args[0]) == False:
            ...
            elif len(args) == 2 and HBNBCommand.class_exists(args[0]):
                # if 2 args and class exists
            ...
            elif (len(args) == 3 and HBNBCommand.class_exists(args[0]) and
                    HBNBCommand.instance_exists(obj_key)):
            ...
            if HBNBCommand.class_exists(args[0]) == False:
                ...
                HBNBCommand.instance_exists(obj_key) == False):
